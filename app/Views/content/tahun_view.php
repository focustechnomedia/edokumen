    ...
    <div class="card-header d-lg-flex justify-content-between align-items-center bg-secondary">
        ...
        <div class="tombol-group">
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-primary btn-modal" href="/tahun_form"><i class="fas fa-plus"></i> Input Data</button>
            ...
            <div class="card card-body">
                <form>
                    <div class="form-group">
                        <label for="prov">Tahun</label>
                        <input type="text" class="form-control" name="keyword" id="idpencarian" placeholder="Cari tahun">
                    </div>
    ...
    <div class="card-body">
        <table class="table table-sm table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($data as $v) : ?>
                    <tr>
                        <td style="width:30px"><a class="btn-modal" href="/tahun_edit/<?= $v['tahun_id']; ?>"><i class="fas fa-pencil-alt text-success"></i></a></td>
                        <td style="width:30px"><a class="swal" href="/tahun_hapus/<?= $v['tahun_id']; ?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
