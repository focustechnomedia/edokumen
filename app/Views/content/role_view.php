    ...
    <div class="card-header d-lg-flex justify-content-between align-items-center bg-secondary">
        ...
        <div class="tombol-group">
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-primary btn-modal" href="/role_form"><i class="fas fa-plus"></i> Input Data</button>
            ...
            <tbody>
                ...
                foreach ($data as $v) : ?>
                    <tr>
                        ...
                        <td style="width:30px"><a class="btn-modal" href="/role_form/<?= $v['role_id']; ?>"><i class="fas fa-pencil-alt text-success"></i></a></td>
                        <td style="width:30px"><a class="swal" href="/role_hapus/<?= $v['role_id']; ?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
                        <td><?= $v['nama_role']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
