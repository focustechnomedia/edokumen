    ...
    <div class="card-header d-lg-flex justify-content-between align-items-center bg-secondary">
        ...
        <div class="tombol-group">
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-primary btn-modal" href="/klasifikasi_form"><i class="fas fa-plus"></i> Input Data</button>
            ...
            <div class="card card-body">
                <form>
                    <div class="form-group">
                        <label for="prov">Klasifikasi</label>
                        <input type="text" class="form-control" name="keyword" id="idpencarian" placeholder="Cari klasifikasi dokumen">
                    </div>
            ...
            <tbody>
                ...
                foreach ($data as $v) : ?>
                    <tr>
                        ...
                        <td style="width:30px"><a class="btn-modal" href="/klasifikasi_form/<?= $v['klasifikasi_id']; ?>"><i class="fas fa-pencil-alt text-success"></i></a></td>
                        <td style="width:30px"><a class="swal" href="/klasifikasi_hapus/<?= $v['klasifikasi_id']; ?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
                        <td><?= $v['kode_klasifikasi']; ?></td>
                        <td><?= $v['klasifikasi']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
